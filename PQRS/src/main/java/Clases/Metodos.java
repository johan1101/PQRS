...
public class Metodos {
    ...
    public static void validarIngreso(String cedula, String contrasena, Connection connection, HttpServletResponse response) throws SQLException, IOException {
        // Consulta SQL para buscar un usuario con la cédula y contraseña proporcionadas
        String sql = "SELECT idRol FROM usuarios WHERE cedula = ? AND contrasena = ?";
